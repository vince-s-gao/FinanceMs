...
const FRIENDLY_ERROR_MESSAGES: Record<string, string> = {
  ...
  [ERROR_CODE.AUTH_FEISHU_NOT_CONFIGURED]: '飞书登录尚未配置完成，请联系管理员',
  [ERROR_CODE.AUTH_FEISHU_STATE_INVALID]: '飞书登录状态校验失败，请重新发起登录',
  [ERROR_CODE.AUTH_FEISHU_APP_TOKEN_FAILED]: '飞书应用认证失败，请检查 App ID/Secret',
  [ERROR_CODE.AUTH_FEISHU_USER_TOKEN_FAILED]: '飞书授权码无效或已过期，请重新登录',
  [ERROR_CODE.AUTH_FEISHU_USERINFO_FAILED]: '获取飞书账号信息失败，请检查应用权限',
  [ERROR_CODE.AUTH_FEISHU_TICKET_INVALID]: '飞书登录票据无效或已过期，请重试',
  [ERROR_CODE.AUTH_REFRESH_TOKEN_MISSING]: '登录状态异常，请重新登录',
  [ERROR_CODE.AUTH_REFRESH_TOKEN_INVALID]: '登录状态已过期，请重新登录',
  [ERROR_CODE.AUTH_MFA_REQUIRED]: '该账号已启用MFA，请输入6位验证码',
  [ERROR_CODE.AUTH_MFA_CODE_INVALID]: 'MFA验证码错误，请重试',
  [ERROR_CODE.AUTH_MFA_NOT_ENABLED]: '该账号尚未启用MFA',
  [ERROR_CODE.AUTH_MFA_NOT_SETUP]: 'MFA尚未完成绑定，请先初始化',
