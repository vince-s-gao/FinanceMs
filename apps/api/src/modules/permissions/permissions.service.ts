...
const DEFAULT_FUNCTION_PERMISSIONS: Record<string, string[]> = {
  ...
  FINANCE: ['expense.create', 'expense.approve', 'expense.pay', 'invoice.create', 'invoice.void', 'budget.create', 'budget.edit'],
  MANAGER: ['expense.create', 'expense.approve', 'customer.create', 'customer.edit', 'customer.approve', 'contract.create', 'contract.edit'],
  ADMIN: ['expense.create', 'expense.approve', 'expense.pay', 'contract.create', 'contract.edit', 'contract.delete', 'customer.create', 'customer.edit', 'customer.delete', 'customer.approve', 'invoice.create', 'invoice.void', 'budget.create', 'budget.edit', 'user.create', 'user.edit', 'department.manage'],
};
