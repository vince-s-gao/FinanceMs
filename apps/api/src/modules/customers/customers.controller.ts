...
export class CustomersController {
  ...
  async importCustomers(@UploadedFile() file: Express.Multer.File | undefined, @CurrentUser() user: any) {
    if (!file) {
    ...
    return this.customersService.importFile(file.buffer, file.originalname, user.id);
  }
