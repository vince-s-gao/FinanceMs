...
export const ERROR_CODE = {
  ...
  AUTH_FEISHU_NOT_CONFIGURED: 'AUTH_FEISHU_NOT_CONFIGURED',
  AUTH_FEISHU_STATE_INVALID: 'AUTH_FEISHU_STATE_INVALID',
  AUTH_FEISHU_APP_TOKEN_FAILED: 'AUTH_FEISHU_APP_TOKEN_FAILED',
  AUTH_FEISHU_USER_TOKEN_FAILED: 'AUTH_FEISHU_USER_TOKEN_FAILED',
  AUTH_FEISHU_USERINFO_FAILED: 'AUTH_FEISHU_USERINFO_FAILED',
  AUTH_FEISHU_TICKET_INVALID: 'AUTH_FEISHU_TICKET_INVALID',
  ...
  AUTH_MFA_NOT_SETUP: 'AUTH_MFA_NOT_SETUP',
